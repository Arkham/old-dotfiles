...
problem in a very simple yet reliable way. This algorithm can also
analyze graphs containing negative-weight arcs: furthermore, it is
able to detect the presence of negative weight loops. Its main
disadvantage is the poor performance compared to the other
